...
data class IdentifierOperatorNode(val identifier: String, val identifierPosition: Position) : BinaryNode // Nombre de variable ej: x  SE USA???
...
data class DeclarationNode(val identifier: String, val identifierPosition: Position, val type: String, val typePosition: Position) : ASTNode // Ej:  let x:number   let y:string
